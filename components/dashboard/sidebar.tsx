    ...
    <div className="aspect-[24/24] grow min-h-px min-w-px overflow-clip relative shrink-0">
      <div className="absolute aspect-[24/16] left-0 right-0 top-1/2 -translate-y-1/2">
        <svg className="block size-full" fill="none" viewBox="0 0 24 16">
          <g>
            <path d={svgPaths.p36880f80} fill="#00ff87" />
            <path d={svgPaths.p355df480} fill="#00ff87" />
            <path d={svgPaths.pfa0d600} fill="#00ff87" />
          </g>
        </svg>
      </div>
    </div>
    ...
    <div className="relative shrink-0 w-full">
      <div className="flex items-center p-1 w-full">
        ...
        <div className="px-2 py-1">
          <div className="font-['Lexend:SemiBold',_sans-serif] text-[16px] text-neutral-50 tracking-tight">
            Lumina Clippers
          </div>
        </div>
      </div>
          ...
          items: [
            {
              ...
              children: [
                { label: "Revenue: +15.3%" },
                { label: "New Followers: 2.4k" },
                { label: "Engagement: 8.7%" },
              ],
            },
          ],
        },
      ...
      sections: [
        {
          ...
          items: [
            {
              icon: <Store size={16} className="text-neutral-50" />,
              label: "All Campaigns",
              href: "/marketplace",
            },
            {
          ...
          items: [
            {
              ...
              children: [
                {
                  icon: <Task size={14} className="text-neutral-300" />,
                  label: "L1/L2 Chains",
                },
                {
                  icon: <Task size={14} className="text-neutral-300" />,
      ...
      sections: [
        {
          ...
          items: [
            {
              icon: <Wallet size={16} className="text-neutral-50" />,
              label: "Overview",
              href: "/wallet",
            },
            {
      ...
      sections: [
        {
          ...
          items: [
            {
              icon: <UserIcon size={16} className="text-neutral-50" />,
          ...
          items: [
            {
              ...
              children: [
                {
                  icon: <View size={14} className="text-neutral-300" />,
                  label: "Theme settings",
                },
                {
                  icon: <Notification size={14} className="text-neutral-300" />,
...
function IconNavigation({
  ...
  const navItems = [
    ...
    { id: "marketplace", icon: <Store size={16} />, label: "Marketplace" },
    { id: "campaigns", icon: <Video size={16} />, label: "Campaigns" },
    { id: "wallet", icon: <Wallet size={16} />, label: "Wallet" },
    { id: "analytics", icon: <Analytics size={16} />, label: "Analytics" },
  ];

  return (
    <aside className="bg-black flex flex-col gap-2 items-center p-4 w-16 h-screen border-r border-neutral-800 sticky top-0 z-50">
      {/* Logo */}
...
function DetailSidebar({ activeSection }: { activeSection: string }) {
  ...
  return (
    <aside
      className={`bg-black flex flex-col gap-4 items-start p-4 border-r border-neutral-800 transition-all duration-500 h-screen sticky top-0 z-40 ${
        isCollapsed ? "w-16 min-w-16 !px-0 justify-center" : "w-80 min-w-80"
      }`}
      style={{ transitionTimingFunction: softSpringEasing }}
    >
      ...
      {!isCollapsed && (
        <div className="w-full mt-auto pt-2 border-t border-neutral-800">
          <div className="flex items-center gap-2 px-2 py-2">
            <AvatarCircle />
            <div className="font-['Lexend:Regular',_sans-serif] text-[14px] text-neutral-50">
              Joshua
            </div>
            <button
              type="button"
